  ...
  return (
    <Container>
      <div className="prose max-w-none mx-auto">
        ...
        <ul>
          <li><strong>{t('about.opensource.github.title')}</strong>：<a href="https://github.com/wekh/zmail" className="text-blue-600 hover:underline">https://github.com/wekh/zmail</a></li>
